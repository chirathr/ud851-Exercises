...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_RESULT = "json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            if (savedInstanceState.containsKey(SEARCH_RESULT)) {
                mSearchResultsTextView.setText(savedInstanceState.getString(SEARCH_RESULT));
            }
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(SEARCH_RESULT, json);
    }
}