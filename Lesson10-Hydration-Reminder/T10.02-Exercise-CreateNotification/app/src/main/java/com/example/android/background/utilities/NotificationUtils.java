...
public class NotificationUtils {
    ...
    public static final String WATER_CHANNEL_ID = "water-channel";
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context, WATER_CHANNEL_ID)
